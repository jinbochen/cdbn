 ...
 * @author Augie
 */
public class ConvertMNISTOneFile {
    ...
    public static void main(String[] args) throws Exception {
        // Check args
        if (args.length != 3) {
            throw new Exception("Expecting 3 args: [MNIST raw image file] [MNIST label file] [output file]");
        }
        int argCount = 0;
        ...
        try {
            ...
            try {
                ...
                out.println(imagesCount);
                // Create a new file for each of the images
